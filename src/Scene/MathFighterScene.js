...
export default class MathFighterScene extends Phaser.Scene {
	...
	gameStart(){
		...
		this.enemy.anims.play('enemy-standby')
    ...
    createButtons(){
	   ...
	   this.button4=this.add.image(this.button5.x - widthDiff, this.button1.y + heightDiff, 'numbers',3).setInteractive()
	   .setData('value',4)
	   this.button7= this.add.image(this.button8.x - widthDiff, 
		this.button4.y+ heightDiff, 'numbers', 6).setInteractive()
		.setData('value', 7)
		this.buttonDel= this.add.image(this.button0.x - widthDiff, this.button7.y + heightDiff, 'numbers', 9).setInteractive()
		.setData('value', 'del')

		//right side
		this.button3= this.add.image(this.button2.x + widthDiff, startPosY, 'numbers', 2).setInteractive().setData('value', 3)
		this.button6= this.add.image(this.button5.x + widthDiff, this.button3.y + heightDiff, 'numbers', 5).setInteractive()
		.setData('value', 6)
	...
	/**
	 * @param {any} pointer
	 * @param {{ getData: (arg0: string) => any; }} object
	...
	generateQuestion(){
		...
		this.questionText.setInteractive(this.question[0])
